...
export default function FullscreenableImage({ ...props }: React.ImgHTMLAttributes<HTMLImageElement>) {
	...
	return (
		<div ref={ref} onClick={() => setFullscreen(!fullscreen)}>
			{fullscreen && <div className="z-40 fixed top-0 left-0 w-screen h-[300dvh] bg-black/20" />}
			<img
				ref={imageRef}
				{...props}
				className={`${
