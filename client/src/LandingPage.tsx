			...
			<div className="flex flex-col items-center w-full text-lg">
				...
				>
					<div className="flex items-center  ">
						<p className="brand text-3xl leading-none! underline p-6">See Active Stacks</p>
						<GoChevronRight
							size={64}
							className="pr-2 text-white group-hover:translate-x-3 transition-all duration-500"
						/>
					</div>
				</Link>
				<div className="w-full bg-light h-15 z-2"></div>
				...
				<div className="px-10 w-full md:w-200 text-dark">
					...
					<p className="mt-5">
						...
						artists that used their likes page as a way to show off cool art from smaller artists. A lot of
						artists complained about no longer being able to give small artists a platform by liking their
						art, but couldn't risk reposting art due to financial concerns.
					</p>
