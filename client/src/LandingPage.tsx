        ...
        <>
            ...
            <div className="bg-dark w-full h-200 2xl:h-230 text-light square">
                ...
                <div className="mt-10 lg:mt-60 2xl:mt-90">
                    ...
                    <div className="invisible lg:visible text-cyan">
                        <p className="left-1/10 absolute w-80 text-2xl text-center -translate-x-40 translate-y-14"> June 2024 </p>
                        <p className="left-3/10 absolute w-80 text-2xl text-center -translate-x-40 translate-y-14"> July 2024 </p>
                        <p className="left-6/10 absolute w-80 text-2xl text-center -translate-x-40 translate-y-14"> Sept 2025 </p>
                        
                        <p className="left-1/10 absolute w-60 text-3xl text-center -translate-x-28 -translate-y-30"> Public Likes Removed ): </p>
                        <img alt="Discord" src="yeah.jpg" className="left-3/10 absolute rounded-lg w-40 aspect-auto -translate-x-18 -translate-y-30" /> 
                        <p className="top-116 2xl:top-146 left-6/10 absolute h-7/5 text-6xl text-center -translate-x-1/2 brand"> Scrapstack </p>
                    </div>

                    {/* Mobile Labels */}
                    <div className="lg:invisible visible text-cyan">
                        <p className="left-3/10 absolute mt-15 w-min text-xl text-center -translate-x-22 translate-y-0"> June 2024 </p>
                        <p className="left-3/10 absolute mt-15 w-min text-xl text-center -translate-x-22 translate-y-40"> July 2024 </p>
                        <p className="left-3/10 absolute mt-15 w-min text-xl text-center -translate-x-22 translate-y-70"> Sept 2025 </p>
                        
                        <p className="left-3/10 absolute mt-15 w-40 text-2xl text-center translate-x-15 translate-y-3"> Public Likes Removed ): </p>
                        <img alt="Discord" src="yeah.jpg" className="left-3/10 absolute mt-15 rounded-lg w-40 aspect-auto translate-x-15 translate-y-41" /> 
                        <p className="top-175 md:left-3/10 absolute sm:ml-13 w-full! md:w-80! h-min text-5xl text-center brand"> Scrapstack </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center w-full text-lg">
                ...
                <div className="px-10 w-full md:w-200 text-dark">
                    ...
                    <p className="mt-5">Login cookies <span className="font-bold text-cyan-dark underline">cannot</span>:</p>
                    <ul>
                    ...
                    <p className="mt-5">Login cookies <span className="font-bold text-cyan-dark underline">can</span>:</p>
                    <ul>
        ...
        <>
            <div className="bg-cyan border-b-10 border-b-cyan-light h-20 text-light">
                <div className="flex justify-between items-center px-10 h-full text-xl">
                    <button className="text-2xl hover:underline cursor-pointer" onClick={() => navigate("/")}>ScrapStack</button>
                    <button className="hover:underline cursor-pointer" onClick={() => navigate("/search")}>Search Stacks</button>
                </div>
            </div>
        </>
    )
